...
// the cached identity.
func LazyBackfillAuthUserID(cfg *config.Config, serverURL string) {
	...
	_ = config.SaveGlobalConfig(func(m map[string]json.RawMessage) error {
